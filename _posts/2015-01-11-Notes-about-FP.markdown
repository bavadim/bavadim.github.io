---
layout: post
title: "Заметки о функциональном программировании. Основы (часть 1)"
comments: true
...
В функциональной программе обычно присутствуют аналоги условных выражений, в этом она похожа на императивные. Таким образом функциональные и императивные программы отличаются в следующем:
